...
def devinette_player_vs_machine_medium(pJoueur1):
    """
    fonction jeu devinette joueur contre machine niveau medium
    ...
    while n_essai_machine != n_essai_max_machine:
        ...
        # la machine choisit la valeur moyenne de l'intervalle
